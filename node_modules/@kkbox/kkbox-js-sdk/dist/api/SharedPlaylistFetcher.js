 ...
 */
var SharedPlaylistFetcher =
/*#__PURE__*/
function (_Fetcher) {
  _inherits(SharedPlaylistFetcher, _Fetcher);

  /**
   * @ignore
   */
  function SharedPlaylistFetcher(http) {
    var _this;

    var territory = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'TW';

    _classCallCheck(this, SharedPlaylistFetcher);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SharedPlaylistFetcher).call(this, http, territory));
    /**
     * @ignore
     */
  ...
  _createClass(SharedPlaylistFetcher, [{
    key: "setPlaylistID",
    ...
    value: function fetchMetadata() {
      return this.http.get(_Endpoint.SHARED_PLAYLISTS + '/' + this.playlistID, {
    ...
    value: function getWidgetUri() {
      return "https://widget.kkbox.com/v1/?id=".concat(this.playlistID, "&type=playlist");
    }
    /**
    ...
    value: function fetchTracks() {
      ...
      return this.http.get(_Endpoint.SHARED_PLAYLISTS + '/' + this.playlistID + '/tracks', {
        territory: this.territory,
        limit: limit,
        offset: offset
      });
...
exports["default"] = SharedPlaylistFetcher;