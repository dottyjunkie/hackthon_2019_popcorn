 ...
 */
var FeaturedPlaylistFetcher =
/*#__PURE__*/
function (_Fetcher) {
  _inherits(FeaturedPlaylistFetcher, _Fetcher);

  /**
   * @ignore
   */
  function FeaturedPlaylistFetcher(http) {
    var territory = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'TW';

    _classCallCheck(this, FeaturedPlaylistFetcher);

    return _possibleConstructorReturn(this, _getPrototypeOf(FeaturedPlaylistFetcher).call(this, http, territory));
  }
  /**
  ...
  _createClass(FeaturedPlaylistFetcher, [{
    key: "fetchAllFeaturedPlaylists",
    value: function fetchAllFeaturedPlaylists() {
      ...
      return this.http.get(_Endpoint.FEATURED_PLAYLISTS, {
        limit: limit,
        offset: offset,
  ...
  return FeaturedPlaylistFetcher;
}(_Fetcher2["default"]);

exports["default"] = FeaturedPlaylistFetcher;